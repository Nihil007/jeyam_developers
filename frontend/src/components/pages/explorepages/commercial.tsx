 ...
 */
const HERO = "/commercial/commercial.webp";

const properties = [
  {
    title: "Madurai - Villa",
    subtitle: "Valley View, CA · 10 acres",
    image: "/commercial/madurai.webp",
  },
  {
    title: "Coimbatore - Industrial Estate",
    subtitle: "Coastal Ridge, CA · 5 acres",
    image: "/commercial/coimbatore.webp",
  },
  {
    title: "Chennai - Business Park",
    subtitle: "Mountain View · 20 acres",
    image: "/commercial/chennai.webp",
  },
  {
    title: "Trichy - Commercial Hub",
    subtitle: "Desert Bloom, AZ · 15 acres",
    image: "/commercial/trichy.webp",
  },
  {
    title: "Salem - Trade Zone",
    subtitle: "Forest Haven, OR · 25 acres",
    image: "/commercial/salem.webp",
  },
  {
    title: "Tirunelveli - Market Area",
    subtitle: "Lakeside, WA · 8 acres",
    image: "/commercial/tirunelveli.webp",
  },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pb-16">
        <h2 className="text-center text-3xl font-bold text-white mb-8">Avaliable Commercial Lands</h2>

...
const AddNewLand: React.FC = () => {
  return (
    ...
    <div className="relative w-full max-w-6xl">
        ...
        {/* Content Layer */}
        <div className="relative h-[280px] sm:h-[320px] md:h-[360px] lg:h-[420px] 
      ...
      {/* Step 1 */}
      <h2 className="text-lg font-semibold mb-4">Step 1: Basic Land Details</h2>

      <div className="grid gap-6 max-w-3xl">
        <div>
          <label className="text-sm">Land Title</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="text-sm">Land Size (in cents or acres)</label>
            <input
              type="text"
        ...
        <div>
          <label className="text-sm">Plot Number / ID</label>
          <input
            type="text"
      ...
      {/* Step 2 */}
      <h2 className="text-lg font-semibold mt-10 mb-4">Step 2: Location Information</h2>

      <div className="grid gap-6 max-w-3xl">
        <div>
          <label className="text-sm">Village / Area Name</label>
          <input
            type="text"
        ...
        <div>
          <label className="text-sm">Nearest Landmark</label>
          <input
            type="text"
      ...
      {/* Step 3 */}
      <h2 className="text-lg font-semibold mt-12 mb-4">Step 3: Upload Images</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl">
        ...
        {/* Gallery Upload - 3 Small Boxes */}
        <div className="flex flex-col gap-6">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="border border-dashed border-emerald-400 rounded-xl p-6 text-center"
            >
              <p className="font-semibold">Drag & Drop Images Here</p>
      ...
      {/* Step 4 */}
      <h2 className="text-lg font-semibold mt-12 mb-4">Step 4: Seller Contact Details</h2>
